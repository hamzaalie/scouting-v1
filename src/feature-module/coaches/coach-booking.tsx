        ...
        return (
            <h2 className="table-avatar">
                <Link to="#" className="avatar avatar-sm  flex-shrink-0">
                    <ImageWithBasePath className="avatar-img" src={res.courtImg} alt="User" />
                </Link>
                <span className="table-head-name flex-grow-1">
                    <Link to="#">{res.courtName}</Link>
                    <span>
                        Court 1 <span className="book-on-date">Booked on : {res.bookedOn}</span>
                    </span>
                </span>
            </h2>
        );
        ...
        return (
            <h2 className="table-avatar">
                <Link to={routes.myProfile} className="avatar avatar-sm  flex-shrink-0">
                    <ImageWithBasePath className="avatar-img" src={res.playerImg} alt="User" />
                </Link>
                                        ...
                                        <div className="col-xl-6 col-lg-6 col-sm-12 col-12">
                                            <div className="coach-court-list">
                                                <ul className="nav">
                                                    ...
                                                    <li>
                                                        <Link to="booking-completed">Terminé</Link>
                                                    </li>
                                                    <li>
                                                        <Link to="booking-cancelled">Annulé</Link>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
