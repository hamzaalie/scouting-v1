...
const CoachWallet = () => {
    ...
    const sortOptions = [{name: "All Transactions"}, {name: "This Week"}, {name: "One Day"}];
                                                ...
                                                <div className="row align-items-center">
                                                    <div className="col-lg-5">
                                                        <div className="court-table-head">
                                                            <h4>Transaction</h4>
                                                            <p>
                                                                Digital wallets facilitate secure
                                                                payments for coaching services.
                                                            </p>
                                                        </div>
                                                    </div>
                            ...
                            <div className="modal-content">
                                <div className="modal-header">
                                    <div className="form-header modal-header-title">
                                        <h4 className="mb-0">Add Montant to Wallet</h4>
                                    </div>
                                    <Link
                                        className="close"
