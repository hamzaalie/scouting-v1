...
const CoachEarning = () => {
    ...
    const statusOptions = [{name: "All Invoices"}, {name: "Terminé"}, {name: "In Progress"}];
        ...
        return (
            <h2 className="table-avatar">
                ...
                <span className="table-head-name flex-grow-1">
                    ...
                    <span>
                        {res.courtNo} <span className="book-on-date">{res.bookingDate}</span>
                    </span>
                </span>
            </h2>
        );
    ...
    const dateTimeRender = (res: coachEarning) => {
        return (
            <h4>
                {res.dateTime1}
                <span>{res.dateTime2}</span>
            </h4>
        );
    };
    const paymentRender = (res: coachEarning) => {
        return <span className="pay-dark">{res.payment}</span>;
    };
                                            ...
                                            <div className="coach-court-list">
                                                <ul className="nav">
                                                    <li>
                                                        <Link
                                                            className="active"
                                                            to={routes.coachEarning}
                                                        >
                                                            Court
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link to={routes.earningCoaching}>
                                                            Coaching
                                                        </Link>
                                                    </li>
                                                </ul>
