            ...
            <div className="content">
                <div className="container">
                    ...
                    <div className="row text-center">
                        ...
                        <div className="col-12 col-sm-12 col-md-12 col-lg-4">
                            <aside className="card booking-details">
                                <h3 className="border-bottom">Booking Détails</h3>
                                <ul>
                                    <li>
                                        <i className="me-2">
                                            <ImageWithBasePath
                    ...
                    <div className="text-center btn-row">
                        <Link className="btn btn-primary me-3 btn-icon" to={routes.lessonType}>
                            <i className="feather-arrow-left-circle me-1" /> Back
                        </Link>
                        <Link className="btn btn-secondary btn-icon" to={routes.lessonPersonalInfo}>
