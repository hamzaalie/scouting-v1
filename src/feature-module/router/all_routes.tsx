export const all_routes = {
    ...
    userInvoiceComplete: "/user/user-invoice/user-complete",
    userInvoiceCancelled: "/user/user-invoice/user-cancelled",
    ...
    userClaimTreated: "/user/user-claim/user-claim-treated",
    userClaimOpened: "/user/user-claim/user-claim-opened",
    userClaimSent: "/user/user-claim/user-claim-sent",
    userClaimRejected: "/user/user-claim/user-claim-rejected",
    userClaimAdd: "/user/user-claim/user-claim-add",
