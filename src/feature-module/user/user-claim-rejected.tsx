        ...
        backendFunctions.claims
            ...
            .then((response: tAllClaims) => {
                ...
                setClaimsToDisplay(
                    response.filter(
                        (claim: tClaim) =>
                            claim.clientId === isUserConnected.id && claim.status === "rejeté"
                    )
                );
            })
            .catch((error) => {
                console.log("🚀 ~ UserClaimRejected ~ error:", error);
                setLoadingData(false);
                setAllClaims([]);
            });
    }, []);
...
export default UserClaimRejected;
