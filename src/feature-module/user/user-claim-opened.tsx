        ...
        backendFunctions.claims
            ...
            .then((response: tAllClaims) => {
                ...
                setClaimsToDisplay(
                    response.filter(
                        (claim: tClaim) =>
                            claim.clientId === isUserConnected.id && claim.status === "ouvert"
                    )
                );
            })
            .catch((error) => {
                console.log("🚀 ~ UserClaimOpened ~ error:", error);
                setLoadingData(false);
                setAllClaims([]);
            });
    }, []);
...
export default UserClaimOpened;
