                ...
                setTransactionsToDisplay(
                    response.filter(
                        (transaction: tTransaction) =>
                            ...
                            failedStatus.includes(transaction.status)
                    )
                );
            })
            .catch((error) => {
        ...
        return (
            <td className="table-accept-btn text-end">
                <Link
                    to="#"
                    className={
                        failedStatus.includes(res.status)
                ...
                >
                    ...
                    ></i>
                    {failedStatus.includes(res.status) ? "Échec" : "Succès"}
                </Link>
            </td>
        );
    };
                                        ...
                                        <div className="col-xl-12 col-lg-12 col-sm-12 col-12">
                                            <div className="coach-court-list">
                                                <ul className="nav">
                                                    ...
                                                    <li>
                                                        <Link to={routes.userInvoiceComplete}>
                                                            Succès
                                                        </Link>
                                                    </li>
                                                    {/*  <li>
                                                    ...
                                                    <li>
                                                        <Link
                                                            to={routes.userInvoiceCancelled}
                                                            className="active"
                                                        >
                                                            Échec
                                                        </Link>
...
export default UserInvoiceCancelled;
